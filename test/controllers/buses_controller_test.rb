...
class BusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus" do
    assert_difference("Bus.count") do
      post buses_url, params: { bus: { body_number: @bus.body_number, plate_number: @bus.plate_number } }
    end
  ...
  test "should update bus" do
    patch bus_url(@bus), params: { bus: { body_number: @bus.body_number, plate_number: @bus.plate_number } }
