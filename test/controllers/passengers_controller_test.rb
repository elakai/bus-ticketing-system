...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference("Passenger.count") do
      post passengers_url, params: { passenger: { contact_number: @passenger.contact_number, email_address: @passenger.email_address, name: @passenger.name } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { contact_number: @passenger.contact_number, email_address: @passenger.email_address, name: @passenger.name } }
